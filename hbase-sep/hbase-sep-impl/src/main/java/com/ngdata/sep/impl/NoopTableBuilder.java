...
final class NoopTableBuilder implements TableBuilder { 
  
  private final Configuration passedInConfiguration; 
  private final TableName tn; 
  
  public NoopTableBuilder(Configuration passedInConfiguration, TableName tn) {
    this.passedInConfiguration = passedInConfiguration; 
    this.tn = tn; 
  }
